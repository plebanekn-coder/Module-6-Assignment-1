 ...
 * services using the class's method setMedium to swap between email, WhatsApp, and SMS service. The class
...
public class AlertSystem {
     ...
     * which notification medium is in use, whether that is the email service, WhatsApp, or 
     * SMS service medium.
     * 
     * @param medium the name of the notification medium that is to be declared, i.e.
     * calling upon the WhatsApp, SMS or Email Service to be the medium where messages travel through.
     */
